      ...
      <div className="w-full max-w-md bg-card rounded-2xl p-8 animate-fade-in" style={{ boxShadow: "var(--shadow-elegant)" }}>
        ...
        <form className="space-y-4">
          <div>
            ...
            <input type="email" className="w-full mt-1 px-3 py-2 rounded-lg border border-input bg-background" placeholder="seu@salao.com" />
          </div>
          <div>
            <label className="text-sm font-medium text-foreground">Senha</label>
            <input type="password" className="w-full mt-1 px-3 py-2 rounded-lg border border-input bg-background" placeholder="••••••••" />
          </div>
          <button type="button" className="w-full py-2.5 rounded-lg text-white font-medium" style={{ background: "var(--gradient-rose-gold)" }}>
            Entrar
          </button>
        </form>
